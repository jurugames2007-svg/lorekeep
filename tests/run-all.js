...
const suites = ['core.test.js','ingest.test.js','generation.test.js','api.test.js','marathon.test.js','ocr.test.js','rpg.test.js','rpg-adversarial.test.js','rpg-loop.test.js','web.test.js','language.test.js','campaign-systems.test.js','visual.test.js'];
